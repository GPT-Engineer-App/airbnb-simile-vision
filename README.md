...
**Project**: airbnb-simile-vision 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Build me an airbnb homepage - no need to add any backend or auth for now. Make it look as close as possible to the image I just posted. 
...
```sh
git clone https://github.com/GPT-Engineer-App/airbnb-simile-vision.git
cd airbnb-simile-vision
npm i
